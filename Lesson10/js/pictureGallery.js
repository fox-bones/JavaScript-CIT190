...
var $frame = $('#viewed-image');     // Container for image
var $thumbs = $('.thumbnail-image');           // Thumbnails
...
$(document).on('click', '.thumbnail-image', function(e){ // When a thumb is clicked on
...
$('.thumbnail-image').eq(0).click();                // Simulate click on first thumb